...
export const TASK_CONFIGS: Record<TaskType, TaskConfig> = {
  ...
  table_extract: { taskType: 'table_extract', category: 'documents', label: 'Table Extraction', description: 'Extract tables from images into structured format', icon: 'grid_on', max_new_tokens: 1024, requiresImage: true, requiresAudio: false, requiresPDF: false, requiresText: false, supportsWebcam: true, enableThinkingByDefault: false, supportsThinkingMode: false, outputFormat: 'markdown', twoPassPipeline: false, requiresPrivacyNotice: false, requiresDisclaimer: false },
