...
export const TASK_CONFIGS: Record<TaskType, TaskConfig> = {
  ...
  pdf_qa: { taskType: 'pdf_qa', category: 'documents', label: 'Multi-Page PDF Q&A', description: 'Ask questions about PDF content', icon: 'description', max_new_tokens: 2048, requiresImage: false, requiresAudio: false, requiresPDF: true, requiresText: true, supportsWebcam: false, enableThinkingByDefault: false, supportsThinkingMode: false, outputFormat: 'text', twoPassPipeline: false, requiresPrivacyNotice: false, requiresDisclaimer: false },
  contract_analyzer: { taskType: 'contract_analyzer', category: 'documents', label: 'Contract Analyzer', description: 'Analyze contracts for risks and key clauses', icon: 'gavel', max_new_tokens: 2048, requiresImage: false, requiresAudio: false, requiresPDF: true, requiresText: false, supportsWebcam: false, enableThinkingByDefault: true, supportsThinkingMode: true, outputFormat: 'json', twoPassPipeline: false, requiresPrivacyNotice: false, requiresDisclaimer: false },
  redline_comparison: { taskType: 'redline_comparison', category: 'documents', label: 'Redline Comparison', description: 'Compare two document versions', icon: 'compare_arrows', max_new_tokens: 2048, requiresImage: false, requiresAudio: false, requiresPDF: true, requiresText: true, supportsWebcam: false, enableThinkingByDefault: true, supportsThinkingMode: true, outputFormat: 'json', twoPassPipeline: false, requiresPrivacyNotice: false, requiresDisclaimer: false },
  ...
  research: { taskType: 'research', category: 'research', label: 'Web Research', description: 'Synthesized answers with live citations', icon: 'search', max_new_tokens: 2048, requiresImage: false, requiresAudio: false, requiresPDF: false, requiresText: true, supportsWebcam: false, enableThinkingByDefault: false, supportsThinkingMode: false, outputFormat: 'json', twoPassPipeline: false, requiresPrivacyNotice: false, requiresDisclaimer: false },
